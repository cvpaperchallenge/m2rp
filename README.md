...
markdown-itが必要です．m2rpのホームディレクトリにて，下記のコマンドによりローカルインストールしてください．
npm install --save markdown-it
今のところネット環境がないと動きません．依存のJavaScriptをダウンロードしているせいです．すみません．
...
## ライセンスとか
MIT
一部，markdown-to-pugをフォークして魔改造しています（https://alexandremasy.github.io/markdown-to-pug/）．
